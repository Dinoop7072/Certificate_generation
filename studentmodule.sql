...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 20, 2021 at 10:47 AM
...
INSERT INTO `bonafide_cert` (`FirstName`, `LastName`, `Department`, `Quota`, `AdmssnYear`, `CurrYear`, `LoanYear`, `AdmssnNo`, `BankName`, `BankBranch`, `DocumentNumber`, `Semester`, `id`) VALUES
('Karthik', 'V', 'cse', 'MGT', 2021, 2021, '1', 'RCS0000', 'Punjab national bank', 'Aluva', '1', 'II', 6);
COMMIT;
